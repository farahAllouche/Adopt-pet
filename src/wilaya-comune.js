...
const States = wilaya_comune.map((e) => e.name);
let allTowns = []
wilaya_comune.forEach((e)=> {
    allTowns = [...new Set([...allTowns, ...e.communes])]

})

function getTowns (wilaya) {
   const wil = wilaya_comune.find((e)=> e.name == wilaya)
   return wil? [...new Set(wil.communes)] : allTowns
}

export {States, allTowns, getTowns}